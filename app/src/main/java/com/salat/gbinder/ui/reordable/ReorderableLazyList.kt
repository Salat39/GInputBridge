...
fun rememberReorderableLazyListState(
    ...
    val orientation by remember(lazyListState) { derivedStateOf { lazyListState.layoutInfo.orientation } }
    val state = remember(
        scope,
        lazyListState,
        scrollThresholdPx,
...
private fun LazyListItemInfo.toLazyCollectionItemInfo(orientation: Orientation) =
    object : LazyCollectionItemInfo<LazyListItemInfo> {
        ...
        override val offset: IntOffset
            get() = IntOffset.Companion.fromAxis(orientation, this@toLazyCollectionItemInfo.offset)
 ...
 * @param enabled Whether or this item is reorderable. If true, the item will not move for other items but may still be draggable. To make an item not draggable, set `enable = false` in [com.salat.gbinder.ui.reordable.draggable] or [Modifier.longPressDraggable] instead.
...
fun LazyItemScope.ReorderableItem(
    ...
    val orientation by remember(state) { derivedStateOf { state.orientation } }
