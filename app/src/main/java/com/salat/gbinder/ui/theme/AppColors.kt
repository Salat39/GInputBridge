...
data class AppColors(
    ...
    val launcherFunctionTileActive: Color,
    val launcherFunctionContent: Color,
    val launcherFunctionContentActive: Color,
    val launcherFunctionIndicator: Color,
    val launcherFunctionIndicatorActive: Color,
    val launcherFunctionTileActiveAmber: Color,
    val launcherFunctionContentActiveAmber: Color,
    val launcherFunctionIndicatorActiveAmber: Color,
    val launcherFunctionTileActiveSoft: Color,
    val launcherFunctionContentActiveSoft: Color,
    val launcherFunctionIndicatorActiveSoft: Color,
    val launcherFunctionTileActiveAmberSoft: Color,
    val launcherFunctionContentActiveAmberSoft: Color,
    val launcherFunctionIndicatorActiveAmberSoft: Color,
