...
internal val DarkAppColors = AppColors(
    ...
    launcherFunctionTileActive = Color(0xFF253A54),
    launcherFunctionContent = Color(0xFFF2F2F7),
    launcherFunctionContentActive = ColorPalette.BrandBlue300,
    launcherFunctionIndicator = Color.White.copy(alpha = .22f),
    launcherFunctionIndicatorActive = Color.White.copy(alpha = .22f),
    launcherFunctionTileActiveAmber = Color(0xFF4A3F27),
    launcherFunctionContentActiveAmber = ColorPalette.Yellow400,
    launcherFunctionIndicatorActiveAmber = Color.White.copy(alpha = .22f),
    statusSuccess = Color(0xFF86b474),
    statusError = Color(0xFFdb4135),
    statusDisabled = Color(0xFF888888),
    statusWarning = Color(0xFFeb995d),
