...
internal val LightAppColors = AppColors(
    ...
    launcherFunctionTileActive = Color(0xFF2563EB),
    launcherFunctionContent = Color(0xFF2C2C30),
    launcherFunctionContentActive = Color.White,
    launcherFunctionIndicator = Color.Black.copy(alpha = .16f),
    launcherFunctionIndicatorActive = Color.White.copy(alpha = .35f),
    launcherFunctionTileActiveAmber = ColorPalette.Yellow500,
    launcherFunctionContentActiveAmber = Color(0xFF1E1500),
    launcherFunctionIndicatorActiveAmber = Color.Black.copy(alpha = .18f),
    launcherFunctionTileActiveSoft = ColorPalette.BrandBlue300,
    launcherFunctionContentActiveSoft = Color(0xFF2563EB),
    launcherFunctionIndicatorActiveSoft = Color.Black.copy(alpha = .16f),
    launcherFunctionTileActiveAmberSoft = ColorPalette.Yellow300,
    launcherFunctionContentActiveAmberSoft = ColorPalette.Yellow800,
    launcherFunctionIndicatorActiveAmberSoft = Color.Black.copy(alpha = .16f),
...
internal val DarkAppColors = AppColors(
    ...
    launcherFunctionTileActive = Color(0xFF1975d0),
    ...
    launcherFunctionContentActiveAmber = Color(0xFF1E1500),
    launcherFunctionIndicatorActiveAmber = Color.Black.copy(alpha = .18f),
    launcherFunctionTileActiveSoft = Color(0xFF253A54),
    launcherFunctionContentActiveSoft = ColorPalette.BrandBlue300,
    launcherFunctionIndicatorActiveSoft = Color.White.copy(alpha = .22f),
    launcherFunctionTileActiveAmberSoft = Color(0xFF4A3F27),
    launcherFunctionContentActiveAmberSoft = ColorPalette.Yellow400,
    launcherFunctionIndicatorActiveAmberSoft = Color.White.copy(alpha = .22f),
    statusSuccess = Color(0xFF86b474),
    statusError = Color(0xFFdb4135),
    statusDisabled = Color(0xFF888888),
    statusWarning = Color(0xFFeb995d),
